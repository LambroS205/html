        ...
        <div class="max-w-7xl mx-auto px-4 py-3">
            <div class="flex items-center gap-3 md:gap-6">
                ...
                <div class="flex-1 relative" id="search-wrapper">
                    <form action="/search.php" method="GET" class="relative" autocomplete="off">
                        <input 
                            type="text" 
                            name="q" 
                            id="search-input"
        ...
        <nav class="bg-bb-dark/50 border-t border-white/10 hidden md:block">
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex items-center gap-1 py-0 overflow-x-auto no-scrollbar">
                    ...
                    <?php endforeach; ?>
                    <!-- Deal tag -->
                    <a href="/search.php?deals=1" class="category-pill whitespace-nowrap px-4 py-2.5 text-sm font-medium text-bb-yellow hover:text-yellow-300 rounded-t-lg transition-all flex items-center gap-1">
                        🔥 Deal Hot
                    </a>
                </div>
            </div>
